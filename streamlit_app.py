...
site_context_descriptions = {
    ...
    # ... include all other descriptions as in the previous full code ...
}

# --- Site context sample images ---
# Add paths to your sample images (local or URL)
site_context_images = {
    "Enhance Only (No Context)": "images/enhance_only.jpg",
    "Modern Metropolis (Day)": "images/modern_day.jpg",
    "Modern Metropolis (Night)": "images/modern_night.jpg",
    "Suburban Neighborhood": "images/suburban.jpg",
    "Japanese Zen Garden": "images/zen_garden.jpg",
    # Add images for all site contexts...
}
