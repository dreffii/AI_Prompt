# utils.py
# All reusable variables and functions for the AI Prompt Generator

# --- Dropdown Options ---
view_angles = [
    "Default Angle","Professional Archviz","Eye-Level","High-Angle","Low-Angle","Aerial / Drone",
...
render_style_opts = [
    "Photorealistic","Ultra Realistic","Interior Design","Isometric","Axonometric View",
...
def generate_prompt(
    ...
    selected_objects = ", ".join([obj for obj, val in objects_dict.items() if val])
